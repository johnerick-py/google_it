...
#     # Vamos criar duas strings, para compará-las
#     new_string = ""
#     reverse_string = ""
#     # Percorrer cada letra da string de entrada
#     for letter in input_string.strip():
#         # Adicione quaisquer letras não em branco ao
#         # fim de uma string, e para a frente
#         # da outra string.
...
# 	last_name.split()
# 	last = last_name[0]
# 	return("{} {}.".format(first_name, last[0]))
...
# The replace_ending 
# function replaces the old string
# in a sentence with the new string,
# but only if the sentence ends with the old string.
# If there is more than one occurrence of the old string
# in the sentence, only the one at the end is replaced,
# not all of them. For example, replace_ending("abcabc", "abc", "xyz")
