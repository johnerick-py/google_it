...
# but never by themselves, and could be several words long. For example, "123 Main Street", "1001 1st Ave",
...
# in a sentence to its upper-case version. For example, highlight_word("Have a nice day", "nice")
...
# create a list of squared numbers (n*n).
# The function receives the variables start and end, and returns a list of squares of consecutive numbers between start
# and end inclusively.
...
# and values of the car_prices dictionary, printing out some information about each one.
